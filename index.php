...
// 3. Fetch Stalls & Products (Filtered by Search)
    ...
    <div class="header-content">
        ...
        <form class="search-bar-container" method="GET" action="index.php">
            <div class="search-input-group">
                ...
                <input type="text" name="search" placeholder="Search for food..." value="<?php echo htmlspecialchars($search); ?>">
            </div>
            <button type="submit" class="filter-btn"><i class="fas fa-sliders-h"></i></button>
        </form>
    </div>
</header>

<!-- Only show Categories and Top Sellers if NOT searching -->
<?php if (empty($search)): ?>
...
<?php foreach ($stalls as $stall): ?>
    ...
    <section class="section-stalls">
        <div class="section-header">
            ...
            <!-- Fixed Visit Stall Link -->
            <div class="see-all">
                <a href="pages/menu.php?stallid=<?php echo $stall['StallId']; ?>" style="text-decoration:none; color:inherit;">Visit Stall</a>
            </div>
        </div>
        <div class="horizontal-scroll">
